...
export function TopSection({
  ...
  return (
    <div className="flex relative overflow-hidden h-svh w-full sm:w-[85%] flex-col sm:flex-row bg-stone-200 sm:rounded-3xl sm:p-2">
      <LogoDriftBackggitround veilClassName="bg-white/85" className="sm:rounded-3xl" />
